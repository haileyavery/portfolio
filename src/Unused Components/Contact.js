...
export const Contact = () => {
    ...
    //before user sent anything, it is empty object
    ...
    const handleSubmit = async (e) => {
        //prevent reloading of page upon submission
        e.preventDefault();
       ...
       setFormDetails(formInitialDetails);
        if (result.code === 200){
            ...
            setStatus({success: false, message: 'Something went wrong, Message not sent successfully. Please try again later.'})
        }
    };
